...
BEGIN
    ...
    ELSE
        /* EITHER Just updating Registers */
        UPDATE Registers SET eid = new_instr_id WHERE course_id = co_id AND sid = sess_id;

        /* OR KEEP RECORD (Personally I feel this makes more sense) */
